        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-blue-500 rounded-xl p-8">
            ...
            <a 
              ...
              className="bg-emergency-foregroud text-black font-bold px-8 py-4 rounded-lg hover:bg-emergency-foreground/90 transition-colors inline-flex items-center space-x-2"
            >
