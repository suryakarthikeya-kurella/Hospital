        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-background rounded-lg shadow-lg p-6 text-center">
              ...
              />
              <h3 className="text-xl font-bold text-foreground">B. Srinivas</h3>
              <p className="text-muted-foreground">Managing Director</p>
              <p className="text-muted-foreground">10+ years of experience</p>
              <p className="text-muted-foreground">GST No: [Placeholder]</p>
            </div>
            ...
            <div className="bg-background rounded-lg shadow-lg p-6 text-center">
              <img
                ...
                className="w-32 h-32 mx-auto rounded-full mb-4"
              />
              <h3 className="text-xl font-bold text-foreground">B. Sandya</h3>
              <p className="text-muted-foreground">Managing Director</p>
              <p className="text-muted-foreground">6+ years of experience</p>
              <p className="text-muted-foreground">GST No: 37AQGPB0863Q</p>
            </div>
          </div>
        </div>
      </section>
