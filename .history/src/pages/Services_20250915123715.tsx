    ...
    <div className="py-20">
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-emergency rounded-xl p-8">
            <h2 className="text-3xl font-bold text-emergency-foreground mb-4">
            ...
            <a 
              ...
              className="bg-emergency-foreground text-emergency font-bold px-8 py-4 rounded-lg hover:bg-emergency-foreground/90 transition-colors inline-flex items-center space-x-2"
            >
