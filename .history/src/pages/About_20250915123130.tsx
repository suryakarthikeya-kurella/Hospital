...
<section className="bg-gradient-to-r from-primary to-secondary py-16 relative">
  <div className="absolute inset-0 opacity-10 bg-pattern bg-cover bg-center"></div> {/* Optional decorative background */}
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 text-center relative z-10">
    ...
    <p className="text-xl lg:text-2xl text-secondary-foreground max-w-4xl mx-auto">
